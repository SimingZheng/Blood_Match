...
import com.example.bloodpoint.user_package.user;
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!PASSWORD_PATTERN.matcher(password).matches()) {
                    registerPassword.setError("Password at least 8 character and no space");
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                final user User = new user(fullName, email, idNumber,
                                        phoneNumber,bloodGroup,"Donor","Donor"+bloodGroup);

//                                users.addListenerForSingleValueEvent(new ValueEventListener() {
//                                    @Override
//                                    public void onDataChange(DataSnapshot dataSnapshot) {
//                                        if (dataSnapshot.child(currentUserId).exists())
//                                            Toast.makeText(DonorRegistrationActivity.this, "Username already exist!", Toast.LENGTH_SHORT).show();
//                                    else{
